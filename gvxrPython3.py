...
class Vectorfff(object):
    ...
    def iterator(self):
        return _gvxrPython3.Vectorfff_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _gvxrPython3.Vectorfff___nonzero__(self)

    def __bool__(self):
        return _gvxrPython3.Vectorfff___bool__(self)

    def __len__(self):
        return _gvxrPython3.Vectorfff___len__(self)

    def __getslice__(self, i, j):
        return _gvxrPython3.Vectorfff___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _gvxrPython3.Vectorfff___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _gvxrPython3.Vectorfff___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _gvxrPython3.Vectorfff___delitem__(self, *args)

    def __getitem__(self, *args):
        return _gvxrPython3.Vectorfff___getitem__(self, *args)

    def __setitem__(self, *args):
        return _gvxrPython3.Vectorfff___setitem__(self, *args)

    def pop(self):
        return _gvxrPython3.Vectorfff_pop(self)

    def append(self, x):
        return _gvxrPython3.Vectorfff_append(self, x)

    def empty(self):
        return _gvxrPython3.Vectorfff_empty(self)

    def size(self):
        return _gvxrPython3.Vectorfff_size(self)

    def swap(self, v):
        return _gvxrPython3.Vectorfff_swap(self, v)

    def begin(self):
        return _gvxrPython3.Vectorfff_begin(self)

    def end(self):
        return _gvxrPython3.Vectorfff_end(self)

    def rbegin(self):
        return _gvxrPython3.Vectorfff_rbegin(self)

    def rend(self):
        return _gvxrPython3.Vectorfff_rend(self)

    def clear(self):
        return _gvxrPython3.Vectorfff_clear(self)

    def get_allocator(self):
        return _gvxrPython3.Vectorfff_get_allocator(self)

    def pop_back(self):
        return _gvxrPython3.Vectorfff_pop_back(self)

    def erase(self, *args):
        return _gvxrPython3.Vectorfff_erase(self, *args)

    def __init__(self, *args):
        _gvxrPython3.Vectorfff_swiginit(self, _gvxrPython3.new_Vectorfff(*args))

    def push_back(self, x):
        return _gvxrPython3.Vectorfff_push_back(self, x)

    def front(self):
        return _gvxrPython3.Vectorfff_front(self)

    def back(self):
        return _gvxrPython3.Vectorfff_back(self)

    def assign(self, n, x):
        return _gvxrPython3.Vectorfff_assign(self, n, x)

    def resize(self, *args):
        return _gvxrPython3.Vectorfff_resize(self, *args)

    def insert(self, *args):
        return _gvxrPython3.Vectorfff_insert(self, *args)

    def reserve(self, n):
        return _gvxrPython3.Vectorfff_reserve(self, n)

    def capacity(self):
        return _gvxrPython3.Vectorfff_capacity(self)
    __swig_destroy__ = _gvxrPython3.delete_Vectorfff

# Register Vectorfff in _gvxrPython3:
_gvxrPython3.Vectorfff_swigregister(Vectorfff)
...
class Vectorddd(object):
    ...
    def iterator(self):
        return _gvxrPython3.Vectorddd_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _gvxrPython3.Vectorddd___nonzero__(self)

    def __bool__(self):
        return _gvxrPython3.Vectorddd___bool__(self)

    def __len__(self):
        return _gvxrPython3.Vectorddd___len__(self)

    def __getslice__(self, i, j):
        return _gvxrPython3.Vectorddd___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _gvxrPython3.Vectorddd___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _gvxrPython3.Vectorddd___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _gvxrPython3.Vectorddd___delitem__(self, *args)

    def __getitem__(self, *args):
        return _gvxrPython3.Vectorddd___getitem__(self, *args)

    def __setitem__(self, *args):
        return _gvxrPython3.Vectorddd___setitem__(self, *args)

    def pop(self):
        return _gvxrPython3.Vectorddd_pop(self)

    def append(self, x):
        return _gvxrPython3.Vectorddd_append(self, x)

    def empty(self):
        return _gvxrPython3.Vectorddd_empty(self)

    def size(self):
        return _gvxrPython3.Vectorddd_size(self)

    def swap(self, v):
        return _gvxrPython3.Vectorddd_swap(self, v)

    def begin(self):
        return _gvxrPython3.Vectorddd_begin(self)

    def end(self):
        return _gvxrPython3.Vectorddd_end(self)

    def rbegin(self):
        return _gvxrPython3.Vectorddd_rbegin(self)

    def rend(self):
        return _gvxrPython3.Vectorddd_rend(self)

    def clear(self):
        return _gvxrPython3.Vectorddd_clear(self)

    def get_allocator(self):
        return _gvxrPython3.Vectorddd_get_allocator(self)

    def pop_back(self):
        return _gvxrPython3.Vectorddd_pop_back(self)

    def erase(self, *args):
        return _gvxrPython3.Vectorddd_erase(self, *args)

    def __init__(self, *args):
        _gvxrPython3.Vectorddd_swiginit(self, _gvxrPython3.new_Vectorddd(*args))

    def push_back(self, x):
        return _gvxrPython3.Vectorddd_push_back(self, x)

    def front(self):
        return _gvxrPython3.Vectorddd_front(self)

    def back(self):
        return _gvxrPython3.Vectorddd_back(self)

    def assign(self, n, x):
        return _gvxrPython3.Vectorddd_assign(self, n, x)

    def resize(self, *args):
        return _gvxrPython3.Vectorddd_resize(self, *args)

    def insert(self, *args):
        return _gvxrPython3.Vectorddd_insert(self, *args)

    def reserve(self, n):
        return _gvxrPython3.Vectorddd_reserve(self, n)

    def capacity(self):
        return _gvxrPython3.Vectorddd_capacity(self)
    __swig_destroy__ = _gvxrPython3.delete_Vectorddd

# Register Vectorddd in _gvxrPython3:
_gvxrPython3.Vectorddd_swigregister(Vectorddd)
...
def useLogFile(*args):
    return _gvxrPython3.useLogFile(*args)

def displayBeam(aState=True):
    return _gvxrPython3.displayBeam(aState)

def displayDetector(aState=True):
    return _gvxrPython3.displayDetector(aState)

def displayNormalVectors(aState=True):
    return _gvxrPython3.displayNormalVectors(aState)

def useWireframe(aState=True):
    return _gvxrPython3.useWireframe(aState)

def useLighing(aState=True):
    return _gvxrPython3.useLighing(aState)

def useNegative(aState=True):
    return _gvxrPython3.useNegative(aState)
...
def clearDetectorEnergyResponse():
    return _gvxrPython3.clearDetectorEnergyResponse()

def loadDetectorEnergyResponse(aFileName, aUnitOfEnergy):
    return _gvxrPython3.loadDetectorEnergyResponse(aFileName, aUnitOfEnergy)
...
def loadMeshFile(aLabel, aFileName, aUnitOfLength, addToRendererAsInnerSurface=True):
    ...
    * `aUnitOfLength` :  
    ...
    """
    return _gvxrPython3.loadMeshFile(aLabel, aFileName, aUnitOfLength, addToRendererAsInnerSurface)
...
def getNumberOfPrimitives(aLabel):
    return _gvxrPython3.getNumberOfPrimitives(aLabel)
...
def scaleNode(aLabel, x, y, z):
    ...
    * `aUnitOfLength` :  
    ...
    """
    return _gvxrPython3.scaleNode(aLabel, x, y, z)
...
def getNodeLocalTransformationMatrix(aLabel):
    return _gvxrPython3.getNodeLocalTransformationMatrix(aLabel)

def getNodeWorldTransformationMatrix(aLabel):
    return _gvxrPython3.getNodeWorldTransformationMatrix(aLabel)
...
def setMixture(*args):
    ...
    * `aMixture` :  
    ...
    """
    return _gvxrPython3.setMixture(*args)
...
def setZoom(aZoomValue):
    return _gvxrPython3.setZoom(aZoomValue)

def getZoom():
    return _gvxrPython3.getZoom()

def setSceneRotationMatrix(aRotationMatrix):
    return _gvxrPython3.setSceneRotationMatrix(aRotationMatrix)

def getSceneRotationMatrix():
    return _gvxrPython3.getSceneRotationMatrix()
...
def setWindowBackGroundColour(R, G, B, aWindowID=-1):
    return _gvxrPython3.setWindowBackGroundColour(R, G, B, aWindowID)

def setWindowBackGroundColor(R, G, B, aWindowID=-1):
    return _gvxrPython3.setWindowBackGroundColor(R, G, B, aWindowID)

def takeScreenshot(aWindowID=-1):
    return _gvxrPython3.takeScreenshot(aWindowID)

def getLatestScreenshot():
    return _gvxrPython3.getLatestScreenshot()
...
def getTotalEnergyWithDetectorResponse():
    return _gvxrPython3.getTotalEnergyWithDetectorResponse()
...
def computeXRayImage(anIntegrateEnergyFlag=True):
    ...
    *   Scanned object material properties  
    ...
    """
    return _gvxrPython3.computeXRayImage(anIntegrateEnergyFlag)
...
def convertHU2mu(anImage, anEnergy, aUnitOfEnergy):
    return _gvxrPython3.convertHU2mu(anImage, anEnergy, aUnitOfEnergy)

def rayIntersect(aLabel, aRayOriginX, aRayOriginY, aRayOriginZ, aRayDirectionX, aRayDirectionY, aRayDirectionZ):
    return _gvxrPython3.rayIntersect(aLabel, aRayOriginX, aRayOriginY, aRayOriginZ, aRayDirectionX, aRayDirectionY, aRayDirectionZ)
...
def getMean(anImage):
    return _gvxrPython3.getMean(anImage)

def getStddev(anImage):
    return _gvxrPython3.getStddev(anImage)
...
def computeRMSE(*args):
    ...
    """
    return _gvxrPython3.computeRMSE(*args)
...
def computeZNCC(*args):
    ...
    """
    return _gvxrPython3.computeZNCC(*args)

def loadReference(aReferenceImage):
    return _gvxrPython3.loadReference(aReferenceImage)

def loadTest(aTestImage):
    return _gvxrPython3.loadTest(aTestImage)

def lineariseTest(aThreshold, aScalingFactor):
    return _gvxrPython3.lineariseTest(aThreshold, aScalingFactor)
...
def FBO2Thrust(aFBO, aThrustVector, anOffset=0):
    return _gvxrPython3.FBO2Thrust(aFBO, aThrustVector, anOffset)
